...
const EXPECTED_TOTAL = 561;   // was 550; -3 evidenceRegistry (specialty descoped: 2 direct checks + 1 no-duplicates loop iteration) +14 evidenceGate (Routing Field Grounding Commit 2)
