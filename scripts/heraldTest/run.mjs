...
const contractPassed = hResult.passed + mResult.passed + fResult.passed + dResult.passed + dxResult.passed;
const contractFailed = hResult.failed + mResult.failed + fResult.failed + dResult.failed + dxResult.failed;
const contractTotal = hResult.total + mResult.total + fResult.total + dResult.total + dxResult.total;
